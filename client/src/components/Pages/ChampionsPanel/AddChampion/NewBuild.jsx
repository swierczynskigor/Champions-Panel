...
import ItemContainer from "../../../Ui/ItemPicker/ItemContainer";
...
export default function NewBuild(props) {
  ...
  const handleSecondRunesChange = (e) => {
    setSecondRunesCat(e.target.value);
  };

  const handlePickSecondRune = (rune, index) => {
    let base = { ...curBuild };
    base.secondRunes[index - 1] = rune;
    setCurBuild(base);
  };
    ...
    <Fragment>
      ...
      <form action="" onSubmit={handleSubmit}>
        ...
        <div className="input">
          ...
          <select value={secondRunesCat} onChange={handleSecondRunesChange}>
            <option value="Domination">Domination</option>
            <option value="Inspiration">Inspiration</option>
            <option value="Precision">Precision</option>
            <option value="Resolve">Resolve</option>
          ...
          <div className="runes-container">
            <RuneContainer
              ...
              idx={1}
              category={secondRunesCat}
              pick={handlePickSecondRune}
              tree={"second"}
            />
            <RuneContainer
